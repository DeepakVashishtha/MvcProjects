...
namespace SmartAdminMvc.Models.DbEntity
{
    ...
    public partial class GreenFieldEntities : DbContext
    {
        ...
        public virtual DbSet<PTIHeader> PTIHeaders { get; set; }
        ...
        public virtual ObjectResult<USP_PTI_LotBySupplierID_Result> USP_PTI_LotBySupplierID(Nullable<int> supplierID)
        {
            var supplierIDParameter = supplierID.HasValue ?
                new ObjectParameter("SupplierID", supplierID) :
                new ObjectParameter("SupplierID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_PTI_LotBySupplierID_Result>("USP_PTI_LotBySupplierID", supplierIDParameter);
        }
    
        public virtual ObjectResult<USP_PTI_PrintTradeItem_Result> USP_PTI_PrintTradeItem(Nullable<int> pTISerialID)
        {
            var pTISerialIDParameter = pTISerialID.HasValue ?
                new ObjectParameter("PTISerialID", pTISerialID) :
                new ObjectParameter("PTISerialID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_PTI_PrintTradeItem_Result>("USP_PTI_PrintTradeItem", pTISerialIDParameter);
        }
    
        public virtual ObjectResult<USP_PTI_ProductItems_Result> USP_PTI_ProductItems()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_PTI_ProductItems_Result>("USP_PTI_ProductItems");
        }
    
        public virtual int USP_PTI_SSCCInsert(Nullable<System.DateTime> transactionDate, Nullable<int> farmFieldPlantID, Nullable<int> productID, Nullable<int> userID, ObjectParameter pTISerialID)
        {
            ...
            var farmFieldPlantIDParameter = farmFieldPlantID.HasValue ?
                new ObjectParameter("FarmFieldPlantID", farmFieldPlantID) :
                new ObjectParameter("FarmFieldPlantID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_PTI_SSCCInsert", transactionDateParameter, farmFieldPlantIDParameter, productIDParameter, userIDParameter, pTISerialID);
        }
        ...
        public virtual ObjectResult<USP_User_Login_Result> USP_User_Login(string email, string password)
        {
            var emailParameter = email != null ?
                new ObjectParameter("Email", email) :
                new ObjectParameter("Email", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<USP_User_Login_Result>("USP_User_Login", emailParameter, passwordParameter);
        }
